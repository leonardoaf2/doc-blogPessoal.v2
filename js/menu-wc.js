                                ...
                                <a href="modules/AppModule.html" data-type="entity-link" >AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-d21fa59a9108b6ff7a2da850073f6f7a"' : 'data-target="#xs-components-links-module-AppModule-d21fa59a9108b6ff7a2da850073f6f7a"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-d21fa59a9108b6ff7a2da850073f6f7a"' :
                                            'id="xs-components-links-module-AppModule-d21fa59a9108b6ff7a2da850073f6f7a"' }>
                                            <li class="link">
